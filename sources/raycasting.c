...
/*   Updated: 2023/12/05 19:02:22 by rroussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void render_texture_line2(int draw_start, int draw_end, int x, double tex_pos, double step, t_cub3d *cub3d, void *texture, int tex_x)
// {
//     int y = draw_start;
//     int *color = 0;
...
//         tex_y = (tex_y >= cub3d->xpm.tex_height) ? cub3d->xpm.tex_height - 1 : tex_y;
...
// RAPH CODE RAYCASTING SAVED2 - trying to correct fisheye effect
// void    draw_rays_3d(t_cub3d *cub3d)
// {
//     // Extracting camera properties
//     float   pos_x = cub3d->cam.p_x;
...
//steps of the raycasting function
    // Extracts camera properties such as position, direction, and plane vectors.
    // Iterates through each column of the screen (x coordinates) to cast rays.
    // Calculates the direction of the ray in camera space and initializes variables for ray casting.
    // Casts rays and checks for collisions with walls in the map.
    // Calculates the distance to the wall and determines the height to render on the screen.
    // Performs texture mapping for the wall.
    // Renders the textured line based on the calculated values.
