...
/*   Updated: 2023/12/05 18:49:35 by toteixei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    draw_rays_3d(t_cub3d *cub3d)
{
    ...
    while (x++ < w)
    {
        ...
        // double ray_dir_x = dir_x + plane_x * camera_x; //commented 3434
        // double ray_dir_y = dir_y + plane_y * camera_x; //commented 3434
